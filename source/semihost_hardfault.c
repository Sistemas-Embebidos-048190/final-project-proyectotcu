/**
 ********************************************************************************
 * @file    semihost_hardfault.c
 * @author  ${user} (Original by NXP)
 * @date    ${date}
 * @brief   Manejador de HardFault para evitar bloqueos por semihosting.
 * Permite que la aplicación corra sin depurador conectado ignorando
 * las instrucciones BKPT 0xAB.
 ********************************************************************************
...
#endif /* !defined (__SEMIHOST_HARDFAULT_DISABLE) */
